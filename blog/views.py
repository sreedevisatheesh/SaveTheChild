...
class SearchView(View):
    def get(self, request, *args, **kwargs):
        ...
        search_result = Post.objects.filter(
            Q(StudentName__icontains=q) | Q(StudentAddress__icontains=q)
        ).all()
...
class PostCreateView(CreateView):
    model = Post
    template_name = "blog/add_applicant.html"
    form_class = PostForm
...
class PostUpdateView(UpdateView):
    model = Post
    template_name = "blog/update_applicant.html"
    form_class = PostForm
...
class PostDeleteView(DeleteView):
    model = Post
    template_name = "blog/delete_applicant.html"
